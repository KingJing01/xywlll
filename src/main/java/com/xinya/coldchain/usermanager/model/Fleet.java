...
public class Fleet {
    ...
    public void setPkCarrier(String pkCarrier) {
        this.pkCarrier = pkCarrier;
    }
    ...
    public void setIdCardNeg(String idCardNeg) {
        this.idCardNeg = idCardNeg;
    }
