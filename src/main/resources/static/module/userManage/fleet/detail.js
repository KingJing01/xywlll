(function () {
    ...
    define([
            ...
            /* 数据初始化 */
            var initData = function (pkCarrier, checkStatus, lockedFlag) {
                /*基础信息的vue对象*/
                baseInfoVue = new Vue({
                    el: '#fleet_base_info',
                    data: {
                    ...
                    mounted: function () {
                        var _self = this;
                        common.ajaxfuncURL("fleet/fleetInfo/" + pkCarrier, "POST", {}, function (resp) {
                            var data = resp.data;
            ...
            fleetDetail.load = function (pkCarrier, checkStatus, lockedFlag,carrType) {
                initDetailHtml();
                initData(pkCarrier, checkStatus, lockedFlag);
                bindEvent(pkCarrier);
            }
            return fleetDetail;
        }
